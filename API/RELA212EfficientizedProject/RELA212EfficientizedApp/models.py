...
class StudyGuide(models.Model):
    ...
    examId = models.ForeignKey(Exam, on_delete=models.CASCADE, related_name='studyGuides', default=None, blank=True, null=True)
    ...
    questionGroupSplitter = models.TextField(default=None, blank=True, null=True) # The string that comes before the question
    questionGroupBeginning = models.TextField(default=None, blank=True, null=True) # The string that begins the questions

class QuestionGroup(models.Model):
    questionGroupId = models.AutoField(primary_key=True)
    studyGuideId = models.ForeignKey(StudyGuide, on_delete=models.CASCADE, related_name='questionGroups', default=None, blank=True, null=True)
...
class Question(models.Model):
    ...
    questionGroupId = models.ForeignKey(QuestionGroup, on_delete=models.CASCADE, related_name='questions', default=None, blank=True, null=True)
    ...
    isNote = models.BooleanField(default=None, blank=True, null=True)
...
class AnswerHint(models.Model):
    ...
    hintText = models.TextField(default=None, blank=True, null=True)

class Answer(models.Model):
    answerId = models.AutoField(primary_key=True)
    questionId = models.OneToOneField(Question, on_delete=models.CASCADE, related_name="answer", default=None, blank=True, null=True)
